...
if __name__ == "__main__":
    ...
    # Example 1: Good news for Manager
    ctx1 = {
        ...
        "data": {
            ...
            "change_pct": 12.5,
            "primary_driver": "improved keyword targeting"
        }
    }
    print("--- Manager Update ---")
    print(generator.generate_narrative(ctx1)["raw_text"])
    print()

    # Example 2: Recommendation for CFO
    ctx2 = {
        "type": "recommendation",
        "stakeholder": "cfo",
        "data": {
            "recommended_action": "cutting wasted ad spend",
            "expected_impact": "$450 monthly savings",
            "primary_metric": "Cost" # needed for headline
        }
    }
    print("--- CFO Recommendation ---")
    print(generator.generate_narrative(ctx2)["raw_text"])
