...
This file is loaded when running alembic commands and sets up:
- Database connection from app settings
- SQLAlchemy metadata for autogenerate
- Migration context for online/offline modes
"""
...
from app.modules.amazon_ppc.anomaly.models import AnomalyAlert, AnomalyHistory
# Commented out - models don't exist
